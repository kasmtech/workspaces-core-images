...
then
    ...
    BUILD_URL="https://kasmweb-build-artifacts.s3.amazonaws.com/kasmvnc/0cb2c0ba9f86c45a451e93548c99a45f1cd4b5c8/output/centos_core/kasmvncserver-0.9.1~beta-1.el7.x86_64.rpm"
else
