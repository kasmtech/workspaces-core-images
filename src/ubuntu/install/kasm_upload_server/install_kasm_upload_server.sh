...
wget --quiet https://kasmweb-build-artifacts.s3.amazonaws.com/kasm_upload_service/eba9cfa220520e8e041e8cd2e031dc763af41806/kasm_upload_service_${ARCH}_bugfix_KASM-5302_reset_code.eba9cf.tar.gz -O /tmp/kasm_upload_server.tar.gz
